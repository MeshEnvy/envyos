...
- **v0.3.0 (2026-08-19): multi-volume FS CLI naming** — companion serial CLI uses `UserData/` + `ExtraFS/` prefixes; operator prefers virtual-root ids (`int0`/`int1`, etc.) over product labels. Repeaters: single `InternalFS`. Scope open (rename vs full VFS). Doc: [`docs/planned/v0.3.0.md`](docs/planned/v0.3.0.md).
