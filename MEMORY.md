...
- **Bench (2026-08-19): wedged InternalFS** — Doc: `envycore/docs/envyos_cli_extensions.md`. Flat `doctor stat|gc|check`; no `doctor fix` or `doctor fs` namespace. GUCP v0.2.0: stat/gc/check + FS error surfacing + atomic prefs + WDT + EndF restamp. Bench: ls/probe/dump envyos-only.
