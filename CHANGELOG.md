...
- **Remote EnvyBoot OTA** — LoRa `.mota` for bootloader updates (symmetric handoff: firmware stages, EnvyBoot self-applies on reboot; BL-before-FW when ABI gate fires). [Design notes](docs/planned/v0.3.0.md).
